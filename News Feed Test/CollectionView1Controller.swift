...
class CollectionView1Controller: UICollectionViewController, CollectionCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        collectionView!.registerNib(UINib(nibName: "CollectionCell1", bundle: nil), forCellWithReuseIdentifier: reuseIdentifier)
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(reuseIdentifier, forIndexPath: indexPath) as! CollectionCell1
